<?php
/**
 * RestfulserviceModelPartListPost400ResponseStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceModelPartListPost400ResponseStatus Class Doc Comment
 *
 * @category Class
 * @description |errorCode|errorMessage| |-------|--------| |-200|files did not open (host issue)| |-201|missing modelNumber| |-202|missing mfgCode| |-203|invalid model number| |-204|invalid model number|
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestfulserviceModelPartListPost400ResponseStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_modelPartList_post_400_response_status';
