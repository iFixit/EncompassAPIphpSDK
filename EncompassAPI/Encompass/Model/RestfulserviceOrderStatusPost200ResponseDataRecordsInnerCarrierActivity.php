<?php
/**
 * RestfulserviceOrderStatusPost200ResponseDataRecordsInnerCarrierActivity
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceOrderStatusPost200ResponseDataRecordsInnerCarrierActivity Class Doc Comment
 *
 * @category Class
 * @description activity from the package carrier
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestfulserviceOrderStatusPost200ResponseDataRecordsInnerCarrierActivity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_orderStatus_post_200_response_data_records_inner_carrierActivity';
    ...
    */
     ...
     * Sets code
     *
     * @param string|null $code delivered
     *
     * @return self
     */
