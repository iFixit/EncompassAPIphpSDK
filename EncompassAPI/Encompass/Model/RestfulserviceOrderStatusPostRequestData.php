<?php
/**
 * RestfulserviceOrderStatusPostRequestData
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceOrderStatusPostRequestData Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulserviceOrderStatusPostRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_orderStatus_post_request_data';
    ...
    */
     ...
     *
     * @param string $reference_number main reference number _(this is what you sent in the `createOrder` service `referenceNumber1` field)_, order# or invoice#
     *
     * @return self
     */
