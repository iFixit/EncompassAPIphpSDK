<?php
/**
 * RestfulserviceSearchPost400ResponseStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceSearchPost400ResponseStatus Class Doc Comment
 *
 * @category Class
 * @description |errorCode|errorMessage| |-------|--------| |-200|invalid json string| |-201|invalid jsonUser| |-202|empty search term| |-203|searchTerm must be at least 3 characters| |-204|no results| |-205|searchTerm must be less than 50 characters|
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestfulserviceSearchPost400ResponseStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_search_post_400_response_status';
