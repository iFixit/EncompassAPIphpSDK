<?php
/**
 * RestfulserviceBrandListPost200ResponseStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceBrandListPost200ResponseStatus Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulserviceBrandListPost200ResponseStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_brandList_post_200_response_status';
    ...
    */
     ...
     * Sets error_code
     *
     * @param string|null $error_code This field will always equal 100, unless there is an error.  This field will display error codes for troubleshooting.
     *
     * @return self
     */
