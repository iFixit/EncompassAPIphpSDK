<?php
/**
 * RestfulserviceReturnRequestPostRequestDataPartsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceReturnRequestPostRequestDataPartsInner Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulserviceReturnRequestPostRequestDataPartsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_returnRequest_post_request_data_parts_inner';
    ...
    protected static array $openAPINullables = [
        ...
        'model_number' => false,
        'serial_number' => false,
        'replacement_order_number' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('replacement_order_number', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets reason_code
     *
     * @param string|null $reason_code reason code for return _Required for Warranty / Replacement_ |Value|Description| |-------|--------| |1|No power| |2|Automatically shuts down| |4|Sound problem| |5|Intermittent power issue| |6|Picture distortion issue| |8|Compatibility issue| |9|Wrong color| |10|Physical Damage| |11|Leak Issue| |12|No Video|
     *
     * @return self
     */
     ...
     * Sets model_number
     *
     * @param string|null $model_number model # of the product then part is returned from _Required for Warranty / Replacement_
     *
     * @return self
     */
     ...
     * Sets serial_number
     *
     * @param string|null $serial_number serial # of the product the part is returned from _Required for Warranty / Replacement_
     *
     * @return self
     */
     ...
     *
     * @param string|null $replacement_order_number replacement order # _Required for Warranty / Replacement if the account is not setup to auto-replace_
     *
     * @return self
     */
    public function setReplacementOrderNumber($replacement_order_number)
    {
        if (is_null($replacement_order_number)) {
            throw new \InvalidArgumentException('non-nullable replacement_order_number cannot be null');
        }
