<?php
/**
 * RestfulserviceModelPartListPostRequestData
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceModelPartListPostRequestData Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulserviceModelPartListPostRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_modelPartList_post_request_data';
    ...
    */
     ...
     * Sets symptom_id
     *
     * @param string|null $symptom_id This could be selected from the `symptoms` array retuned by this service on the first call if we have parts prediction data available for this model.
     *
     * @return self
     */
