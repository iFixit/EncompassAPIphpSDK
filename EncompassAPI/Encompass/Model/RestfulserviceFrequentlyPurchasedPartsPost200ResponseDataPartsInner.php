<?php
/**
 * RestfulserviceFrequentlyPurchasedPartsPost200ResponseDataPartsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceFrequentlyPurchasedPartsPost200ResponseDataPartsInner Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulserviceFrequentlyPurchasedPartsPost200ResponseDataPartsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_frequentlyPurchasedParts_post_200_response_data_parts_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('picture_path', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $available_quantity quantity available to ship
     *
     * @return self
     */
     ...
     * Sets picture_path
     *
     * @param string|null $picture_path URL for image
     *
     * @return self
     */
    public function setPicturePath($picture_path)
    {
        if (is_null($picture_path)) {
            throw new \InvalidArgumentException('non-nullable picture_path cannot be null');
        }
