<?php
/**
 * RestfulservicePartsInformationPost400ResponseStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulservicePartsInformationPost400ResponseStatus Class Doc Comment
 *
 * @category Class
 * @description |errorCode|errorMessage| |-------|--------| |-200|files did not open (host issue)| |-201|invalid jsonUser| |-202|missing customer number| |-203|invalid customer number| |-204|invalid customer password| |-205|invalid part number|
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RestfulservicePartsInformationPost400ResponseStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_partsInformation_post_400_response_status';
