<?php
/**
 * RestfulserviceCancelOrderPost200ResponseStatus
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceCancelOrderPost200ResponseStatus Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulserviceCancelOrderPost200ResponseStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_cancelOrder_post_200_response_status';
    ...
    */
     ...
     * Sets error_code
     *
     * @param string|null $error_code This field will always equal 100, unless there is an error.  This field will displayerror codes for troubleshooting.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message If there is an error, this field will display error codes for troubleshooting.
     *
     * @return self
     */
