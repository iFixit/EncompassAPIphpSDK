<?php
/**
 * RestfulservicePartsInformationPost200ResponseDataPartsInnerCompatibleModelsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulservicePartsInformationPost200ResponseDataPartsInnerCompatibleModelsInner Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulservicePartsInformationPost200ResponseDataPartsInnerCompatibleModelsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_partsInformation_post_200_response_data_parts_inner_compatibleModels_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id this can be passed to the model service
     *
     * @return self
     */
     ...
     * Sets model
     *
     * @param string|null $model model number
     *
     * @return self
     */
