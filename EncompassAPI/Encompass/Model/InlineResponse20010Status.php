...
/**
 * InlineResponse20010Status Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse20010Status implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_10_status';
     ...
     * Sets error_code
     *
     * @param string $error_code This field will always equal 100, unless there is an error.  This field will displayerror codes for troubleshooting.
     *
     * @return $this
     */
     ...
     * Sets error_message
     *
     * @param string $error_message If there is an error, this field will display error codes for troubleshooting.
     *
     * @return $this
     */
