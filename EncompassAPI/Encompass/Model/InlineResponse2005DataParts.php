...
class InlineResponse2005DataParts implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'symptoms' => '\Encompass\SDK\Model\InlineResponse2005DataSymptoms[]',
        'wiseable' => 'string'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['available_quantity_manufacturer'] = isset($data['available_quantity_manufacturer']) ? $data['available_quantity_manufacturer'] : null;
        ...
        $this->container['wiseable'] = isset($data['wiseable']) ? $data['wiseable'] : null;
    }
     ...
     *
     * @param string $available_quantity_manufacturer quantity available to ship from Manufacturer
     *
     * @return $this
     */
     ...
     *
     * @param string $estimated_delivery_date estimated delivery date - will only be returned if `serviceLevel`, `destinationZipCode`, and `destinationCountry` were provided.  Valid in the US only.
     *
     * @return $this
     */
     ...
     * Gets symptoms
     *
     * @return \Encompass\SDK\Model\InlineResponse2005DataSymptoms[]
     */
     ...
     * Sets symptoms
     *
     * @param \Encompass\SDK\Model\InlineResponse2005DataSymptoms[] $symptoms list of symptoms that you are using this part to fix. This will help us provide you with better part prediction data.
     *
     * @return $this
     */
     ...
     * Sets wiseable
     *
     * @param string $wiseable Is the part WISE-able? This only pertains to Whirlpool. |Value|Description| |-------|--------| |null|does not apply| |Y|not a WISE-able part| |N|WISE-able part|
     *
     * @return $this
     */
