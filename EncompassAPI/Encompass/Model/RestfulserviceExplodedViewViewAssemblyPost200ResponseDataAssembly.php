<?php
/**
 * RestfulserviceExplodedViewViewAssemblyPost200ResponseDataAssembly
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceExplodedViewViewAssemblyPost200ResponseDataAssembly Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulserviceExplodedViewViewAssemblyPost200ResponseDataAssembly implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_explodedView_viewAssembly_post_200_response_data_assembly';
    ...
    protected static $openAPITypes = [
        ...
        'parent_name' => 'string',
        'image_url' => 'string',
        'hot_spots' => '\Encompass\SDK\Model\RestfulserviceExplodedViewViewAssemblyPost200ResponseDataAssemblyHotSpotsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('hot_spots', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets hot_spots
     *
     * @return \Encompass\SDK\Model\RestfulserviceExplodedViewViewAssemblyPost200ResponseDataAssemblyHotSpotsInner[]|null
     */
     ...
     * Sets hot_spots
     *
     * @param \Encompass\SDK\Model\RestfulserviceExplodedViewViewAssemblyPost200ResponseDataAssemblyHotSpotsInner[]|null $hot_spots array of hotspot corrdinates for adding over the main image.  This array will be in the same order as the `parts` array.
     *
     * @return self
     */
    public function setHotSpots($hot_spots)
    {
        if (is_null($hot_spots)) {
            throw new \InvalidArgumentException('non-nullable hot_spots cannot be null');
        }
