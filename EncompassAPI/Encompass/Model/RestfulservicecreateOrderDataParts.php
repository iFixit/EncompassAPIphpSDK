...
class RestfulservicecreateOrderDataParts implements ModelInterface, ArrayAccess
{
     ...
     * Sets symptom_id
     *
     * @param string $symptom_id Provide the symptom you are fixing and help us provide you with better part prediction data.  This value comes from the `partInformation` or `modelPartLIst` service
     *
     * @return $this
     */
