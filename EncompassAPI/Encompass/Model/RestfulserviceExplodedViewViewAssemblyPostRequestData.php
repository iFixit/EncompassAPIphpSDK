<?php
/**
 * RestfulserviceExplodedViewViewAssemblyPostRequestData
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceExplodedViewViewAssemblyPostRequestData Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulserviceExplodedViewViewAssemblyPostRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_explodedView_viewAssembly_post_request_data';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('zoom_level', $data ?? [], '-1');
    ...
    */
     ...
     * Sets zoom_level
     *
     * @param string|null $zoom_level Zoom level of image URL returned |Zoom Level|Description| |-------|--------| |-1|xxs| |0|xs| |1|s| |2|m| |3|l| |4|xl| |5|xxl|
     *
     * @return self
     */
