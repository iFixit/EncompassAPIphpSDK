<?php
/**
 * OrderRequestPostRequestSettings
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * OrderRequestPostRequestSettings Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class OrderRequestPostRequestSettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_orderRequest_post_request_settings';
    ...
    {
        $this->setIfExists('buyercookie', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['buyercookie'] === null) {
            $invalidProperties[] = "'buyercookie' can't be null";
        }
    ...
    {
        return $this->container['buyercookie'];
    }

    /**
     * Sets buyercookie
     *
     * @param string $buyercookie Must aquire credentials from Encompass
     *
     * @return self
     */
    public function setBuyercookie($buyercookie)
    {
        if (is_null($buyercookie)) {
            throw new \InvalidArgumentException('non-nullable buyercookie cannot be null');
        }
        $this->container['buyercookie'] = $buyercookie;
