<?php
/**
 * RestfulserviceSearchPost200ResponseDataPartsInner
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * RestfulserviceSearchPost200ResponseDataPartsInner Class Doc Comment
 *
 * @category Class
 * @package  Encompass\SDK
 * @author   OpenAPI Generator team
 ...
 */
class RestfulserviceSearchPost200ResponseDataPartsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_restfulservice_search_post_200_response_data_parts_inner';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('part_image', $data ?? [], null);
    ...
    */
     ...
     * Sets base_pn
     *
     * @param string|null $base_pn base_pn
     *
     * @return self
     */
     ...
     * Sets part_image
     *
     * @param string|null $part_image part_image
     *
     * @return self
     */
    public function setPartImage($part_image)
    {
        if (is_null($part_image)) {
            throw new \InvalidArgumentException('non-nullable part_image cannot be null');
        }
