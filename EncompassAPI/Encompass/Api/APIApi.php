...
class APIApi
{
     ...
     *
     * @param  \Encompass\SDK\Model\RestfulserviceShiptoBody $body body (required)
     *
     * @throws \Encompass\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Encompass\SDK\Model\InlineResponse2007
     */
    public function restfulserviceShiptoPost($body)
    {
        list($response) = $this->restfulserviceShiptoPostWithHttpInfo($body);
        return $response;
    }
     ...
     * Customer Ship To list
     *
     * @param  \Encompass\SDK\Model\RestfulserviceShiptoBody $body (required)
     *
     * @throws \Encompass\SDK\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Encompass\SDK\Model\InlineResponse2007, HTTP status code, HTTP response headers (array of strings)
     */
    public function restfulserviceShiptoPostWithHttpInfo($body)
    {
        $returnType = '\Encompass\SDK\Model\InlineResponse2007';
        $request = $this->restfulserviceShiptoPostRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restfulserviceShiptoPostAsync($body)
    {
        return $this->restfulserviceShiptoPostAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restfulserviceShiptoPostAsyncWithHttpInfo($body)
    {
        $returnType = '\Encompass\SDK\Model\InlineResponse2007';
        $request = $this->restfulserviceShiptoPostRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function restfulserviceShiptoPostRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling restfulserviceShiptoPost'
            );
        }
