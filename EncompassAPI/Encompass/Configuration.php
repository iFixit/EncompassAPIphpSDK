...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://test.encompass.com';
    ...
    {
        $report  = 'PHP SDK (Encompass\SDK) Debug Report:' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://test.encompass.com",
                "description" => "Development server (uses test data - no orders will be placed)",
            ],
            [
                "url" => "https://encompass.com",
                "description" => "Production server __(uses live data - orders will be placed)__",
            ]
        ];
    }
